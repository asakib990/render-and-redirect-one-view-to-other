...
class AccountMove(models.Model):
    ...
    is_admission_application_invoice = fields.Boolean(string="Is Admission application Invoice", default=False)
    # application_id = fields.Many2one(comodel_name="se.application",
